        ...
        <div className={cn(
          ...
          <div className="flex items-start gap-3">
            ...
            <p className={cn("text-sm sm:text-base leading-relaxed", t.cardForeground)}>
              Мы приглашаем к участию девушек <strong>Краснокаменска и Забайкальского края</strong> не моложе <strong>18 лет</strong>.
